...
// import 'package:flutter_browser/qr.dart';
  ...
  Future _scanQR() async {
    try {
      ...
      setState(() {
        ...
        // qr=true;
        openNewTab(result);
        print(result);// setting string result with cameraScanResult
      });
        ...
        children: <Widget>[
          TextField(
            ...
            decoration: InputDecoration(
              suffixIcon: Container(child: IconButton(
              ...
              contentPadding: const EdgeInsets.only(
                  left: 45.0, top: 10.0, right: 0.0, bottom: 10.0),
              filled: true,
  ...
  void openNewTab(result) {
    ...
    browserModel.addTab(WebViewTab(
      ...
      webViewModel: WebViewModel(
          url: WebUri(result.startsWith("http")
              ? result
              : settings.searchEngine.searchUrl + result)),
    ));
  }
}
